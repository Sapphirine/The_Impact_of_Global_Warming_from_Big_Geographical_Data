...
val data = sc.textFile("../datasets/time_temp_sl_below.csv")
...
model.toPMML("../exported_pmml_models/linearregression_below.xml")


// Test model on training data
var predictedValue = model.predict(Vectors.dense(100,0.1))
// Random Temp
